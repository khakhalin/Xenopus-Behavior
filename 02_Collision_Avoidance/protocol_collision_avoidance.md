...
8. Record a video for post-processing, but also quantify each trial as you go, as either a "success "(if the avoidance response was triggered; **Fig 1 C, D**) or a "failure".
